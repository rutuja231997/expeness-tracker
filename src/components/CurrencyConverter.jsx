...
const CurrencyConverter = ({ converterRef }) => {
  const {
    baseCurrency,
    targetCurrency,
    setTargetCurrency,
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div className="grid grid-cols-1">
          ...
          <select
            ...
            className="caret-transparent text-base text-semibold text-gray-800 border border-gray-300 p-2"
          >
      ...
      {/* result box */}
      <div className="bg-emerald-50 border border-gray-300 p-2 rounded-2xl">
        {loading ? (
          <p className="text-lg font-medium">Loading exchange data</p>
        ) : error ? (
